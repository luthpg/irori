/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: d3fee3f8d41174ac37b998b73f55072e)
// Runtime types generated with workerd@1.20260714.1 2026-07-09 
interface __BaseEnv_CloudflareBindings {
	irori_db: D1Database;
	ROOM_SESSION: DurableObjectNamespace<import("./src/index").RoomSession>;
}
